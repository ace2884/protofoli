...
function Start-Server {
    ...
    if ($existing) {
        Write-Output "Python process already running. Use 'status' to inspect or 'stop' to stop it."
        return
    }
...
>>>>>>> 29f2383 (chore: add start-server helper)
>>>>>>> 16990f12366d766462624a2c3abe83ed506fc7cb
